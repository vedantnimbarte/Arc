...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::git_host::git_host_viewer,
            commands::git_host::git_host_repo_list,
            commands::git_host::git_host_repo_search,
            commands::git_host::git_host_org_list,
            commands::git_host::git_host_clone,
            commands::git_host::git_host_issue_list,
            commands::git_host::git_host_issue_get,
            commands::git_host::git_host_issue_create,
            commands::git_host::git_host_issue_comment,
            commands::git_host::git_host_issue_set_state,
            commands::git_host::git_host_label_list,
            commands::git_host::git_host_pr_list_for,
            commands::git_host::git_host_pr_get_for,
            commands::git_host::git_host_pr_merge,
            commands::git_host::git_host_pr_reviews,
            commands::git_host::git_host_check_runs,
            commands::git_host::git_host_run_list,
            commands::git_host::git_host_run_jobs,
            commands::git_host::git_host_run_rerun,
            commands::git_host::git_host_run_cancel,
            commands::git_host::git_host_release_list,
            commands::git_host::git_host_notification_list,
            commands::git_host::git_host_notification_read,
            commands::git_host::git_host_rate_remaining,
