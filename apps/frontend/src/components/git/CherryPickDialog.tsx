  ...
  return (
    ...
    >
      <div
        ...
        className="material-sheet mt-[12vh] flex w-[520px] max-w-[92vw] animate-sheet-in flex-col overflow-hidden rounded-window shadow-sheet ring-1 ring-edge-2"
      >
        ...
        <div className="border-b border-border-hairline px-4 py-2">
          <div className="font-display text-2xs uppercase tracking-wider text-fg-subtle">
            commit
          </div>
          <div className="mt-1 flex items-center gap-2">
            <span className="rounded bg-surface-2 px-1.5 py-0.5 font-mono text-2xs text-fg-base">
              {target.shortOid}
            </span>
        ...
        <div className="max-h-[40vh] overflow-y-auto py-1">
          {loading && (
            <div className="px-4 py-4 text-center font-display text-xs italic text-fg-subtle">
              loading branches…
            </div>
          )}
          ...
          {visible.map((b) => (
            ...
            >
              ...
              {b.upstream && (
                <span className="font-mono text-2xs text-fg-subtle">→ {b.upstream}</span>
              )}
            </button>
          ))}
        </div>
